    ...
    !(function () {
            ...
            return (
                ...
                (i.prototype.setOptions = function (t) {
                    return (
                        ...
                        this.textField && (this.textField.el.style.fontSize = t.fontSize + "px"),
                    ...
                    (t.prototype.update = function (t) {
                        ...
                        return (
                            ...
                            !(!t && this.displayedValue === this.value) &&
                                ...
                                Math.abs(i / this.animationSpeed) <= 0.001 ? (this.displayedValue = this.value) : (this.displayedValue = this.displayedValue + i / this.animationSpeed),
                                this.render(),
                                !0)
                        );
                    }),
        ...
        (a = (function (t) {
            ...
            return (
                ...
                (i.prototype.displayedValue = 0),
                (i.prototype.value = 0),
                (i.prototype.options = { strokeWidth: 0.035, length: 0.1, color: "#000000", iconPath: null, iconScale: 1, iconAngle: 0 }),
                ...
                (i.prototype.setOptions = function (t) {
                    if (
                        ...
                        return (this.img = new Image()), (this.img.src = this.options.iconPath);
                }),
                (i.prototype.render = function () {
        ...
        (o = (function (t) {
            ...
            return (
                f(e, t),
                (e.prototype.elem = null),
                (e.prototype.value = [20]),
                (e.prototype.maxValue = 80),
                (e.prototype.minValue = 0),
                (e.prototype.displayedAngle = 0),
                (e.prototype.displayedValue = 0),
                (e.prototype.lineWidth = 40),
                (e.prototype.paddingTop = 0.1),
                (e.prototype.paddingBottom = 0.1),
                (e.prototype.percentColors = null),
                (e.prototype.options = {
                    colorStart: "#6fadcf",
                    colorStop: void 0,
                    gradientType: 0,
                ...
                (e.prototype.setOptions = function (t) {
                    ...
                    for (
                        null == t && (t = null),
                            e.__super__.setOptions.call(this, t),
                            this.configPercentColors(),
                            this.extraPadding = 0,
                            this.options.angle < 0 && ((o = Math.PI * (1 + this.options.angle)), (this.extraPadding = Math.sin(o))),
                            this.availableHeight = this.canvas.height * (1 - this.paddingTop - this.paddingBottom),
                            this.lineWidth = this.availableHeight * this.options.lineWidth,
                            this.radius = (this.availableHeight - this.lineWidth / 2) / (1 + this.extraPadding),
                        ...
                        (i = a[s]).setOptions(this.options.pointer), i.render();
                ...
                (e.prototype.configPercentColors = function () {
                    ...
                    if (((this.percentColors = null), void 0 !== this.options.percentColors)) {
                        for (this.percentColors = new Array(), o = [], e = s = 0, n = this.options.percentColors.length - 1; 0 <= n ? s <= n : s >= n; e = 0 <= n ? ++s : --s)
                            (a = parseInt(c(this.options.percentColors[e][1]).substring(0, 2), 16)),
                                (i = parseInt(c(this.options.percentColors[e][1]).substring(2, 4), 16)),
                                (t = parseInt(c(this.options.percentColors[e][1]).substring(4, 6), 16)),
                                o.push((this.percentColors[e] = { pct: this.options.percentColors[e][0], color: { r: a, g: i, b: t } }));
                        return o;
                    }
                }),
                (e.prototype.set = function (t) {
                    ...
                    if (t.length > this.gp.length) for (s = o = 0, c = t.length - this.gp.length; 0 <= c ? o < c : o > c; s = 0 <= c ? ++o : --o) (e = new a(this)).setOptions(this.options.pointer), this.gp.push(e);
                    else t.length < this.gp.length && (this.gp = this.gp.slice(this.gp.length - t.length));
                    for (s = 0, r = 0, h = t.length; r < h; r++)
                        (p = t[r]) > this.maxValue ? (this.options.limitMax ? (p = this.maxValue) : (this.maxValue = p + 1)) : p < this.minValue && (this.options.limitMin ? (p = this.minValue) : (this.minValue = p - 1)),
                            (this.gp[s].value = p),
                            this.gp[s++].setOptions({ minValue: this.minValue, maxValue: this.maxValue, angle: this.options.angle });
                            ...
                            if (t <= this.percentColors[n].pct) {
                                !0 === i
                                    ? ((r = this.percentColors[n - 1] || this.percentColors[0]),
                                      ...
                                      (e = { r: Math.floor(r.color.r * (1 - a) + s.color.r * a), g: Math.floor(r.color.g * (1 - a) + s.color.g * a), b: Math.floor(r.color.b * (1 - a) + s.color.b * a) }))
                    ...
                    for (
                        ...
                        void 0 !== (g = c[a]).label
                            ? (!this.options.limitMin || g >= this.minValue) &&
                              ...
                              ((r = (n = g.font || t.font).match(l)[0]),
                              (u = n.slice(r.length)),
                              (o = parseFloat(r) * this.displayScale),
                              (this.ctx.font = o + u),
                              (d = this.getAngle(g.label) - (3 * Math.PI) / 2),
                              this.ctx.rotate(d),
                              this.ctx.fillText(p(g.label, t.fractionDigits), 0, -s - this.lineWidth / 2),
                              this.ctx.rotate(-d))
                            : (!this.options.limitMin || g >= this.minValue) &&
                              (!this.options.limitMax || g <= this.maxValue) &&
                              ((d = this.getAngle(g) - (3 * Math.PI) / 2), this.ctx.rotate(d), this.ctx.fillText(p(g, t.fractionDigits), 0, -s - this.lineWidth / 2), this.ctx.rotate(-d));
                    ...
                    if (t != {}) {
                        for (
                            ...
                            (this.ctx.lineWidth = this.lineWidth * h),
                                (f = (this.lineWidth / 2) * (1 - h)),
                                (M = this.radius * this.options.radiusScale + f),
                                (this.ctx.strokeStyle = a),
                                this.ctx.beginPath(),
                                this.ctx.arc(0, 0, M, this.getAngle(n - r), this.getAngle(n + r), !1),
                                this.ctx.stroke(),
                                (o = n + v),
                                (n += d),
                                S !== t.divisions && w > 0
                                          ...
                                          function () {
                                              ...
                                              for (e = [], t = 0, i = w - 1; t < i; t += 1)
                                                  (this.ctx.lineWidth = this.lineWidth * y),
                                                      (f = (this.lineWidth / 2) * (1 - y)),
                                                      (M = this.radius * this.options.radiusScale + f),
                                                      (this.ctx.strokeStyle = x),
                                                      this.ctx.beginPath(),
                                                      this.ctx.arc(0, 0, M, this.getAngle(o - V), this.getAngle(o + V), !1),
                                                      this.ctx.stroke(),
                                                      e.push((o += v));
                                              return e;
                                          }.call(this)
                ...
                (e.prototype.render = function () {
                    ...
                    if (
                        ...
                        this.options.staticLabels && this.renderStaticLabels(this.options.staticLabels, f, e, l),
                        this.options.staticZones)
                    )
                        for (this.ctx.save(), this.ctx.translate(f, e), this.ctx.lineWidth = this.lineWidth, s = 0, o = (c = this.options.staticZones).length; s < o; s++)
                            (r = (x = c[s]).min),
                                this.options.limitMin && r < this.minValue && (r = this.minValue),
                                (h = x.max),
                                this.options.limitMax && h > this.maxValue && (h = this.maxValue),
                                (m = this.radius * this.options.radiusScale),
                                x.height && ((this.ctx.lineWidth = this.lineWidth * x.height), (u = (this.lineWidth / 2) * (x.offset || 1 - x.height)), (m = this.radius * this.options.radiusScale + u)),
                                (this.ctx.strokeStyle = x.strokeStyle),
                                this.ctx.beginPath(),
                                this.ctx.arc(0, 0, m, this.getAngle(r), this.getAngle(h), !1),
                                this.ctx.stroke();
                    else
                        void 0 !== this.options.customFillStyle
                            ? (i = this.options.customFillStyle(this))
                            : null !== this.percentColors
                            ? (i = this.getColorForValue(this.displayedValue, this.options.generateGradient))
                            : void 0 !== this.options.colorStop
                            ? (0 === this.options.gradientType ? ((d = l - this.lineWidth / 2), (g = l + this.lineWidth / 2), (i = this.ctx.createRadialGradient(f, e, d, f, e, g))) : (i = this.ctx.createLinearGradient(0, 0, f, 0)),
                            ...
                            this.ctx.beginPath(),
                            this.ctx.arc(f, e, l, (1 + this.options.angle) * Math.PI, t, !1),
                            (this.ctx.lineWidth = this.lineWidth),
                            this.ctx.stroke(),
                            (this.ctx.strokeStyle = this.options.strokeColor),
                            this.ctx.beginPath(),
                            this.ctx.arc(f, e, l, t, (2 - this.options.angle) * Math.PI, !1),
                            this.ctx.stroke(),
                            this.ctx.save(),
                            this.ctx.translate(f, e);
        ...
        (e = (function (t) {
            ...
            return (
                f(e, t),
                (e.prototype.lineWidth = 15),
                (e.prototype.displayedValue = 0),
                (e.prototype.value = 33),
                (e.prototype.maxValue = 80),
                (e.prototype.minValue = 0),
                (e.prototype.options = { lineWidth: 0.1, colorStart: "#6f6ea0", colorStop: "#c0c0db", strokeColor: "#eeeeee", shadowColor: "#d5d5d5", angle: 0.35, radiusScale: 1 }),
                (e.prototype.getAngle = function (t) {
                ...
                (e.prototype.set = function (t) {
                    return (
                        ...
                        this.value > this.maxValue
                            ...
                            : this.value < this.minValue && (this.options.limitMin ? (this.value = this.minValue) : (this.minValue = this.value)),
                        i.add(this),
                        i.run(this.forceUpdate),
                        (this.forceUpdate = !1)
                    );
                }),
                (e.prototype.render = function () {
                    ...
                    return (
                        ...
                        (i = this.ctx.createRadialGradient(o, e, s, o, e, n)).addColorStop(0, this.options.colorStart),
                        i.addColorStop(1, this.options.colorStop),
                        (this.ctx.strokeStyle = this.options.strokeColor),
                        this.ctx.beginPath(),
                        this.ctx.arc(o, e, this.radius, (1 - this.options.angle) * Math.PI, (2 + this.options.angle) * Math.PI, !1),
                        (this.ctx.lineWidth = this.lineWidth),
                        (this.ctx.lineCap = "round"),
                        this.ctx.stroke(),
                        (this.ctx.strokeStyle = i),
                        this.ctx.beginPath(),
                        this.ctx.arc(o, e, this.radius, (1 - this.options.angle) * Math.PI, t, !1),
                        this.ctx.stroke()
                    );
                }),
                e
        ...
        (n = (function (t) {
            ...
            return (
                ...
                (i.prototype.strokeGradient = function (t, i, e, s) {
                    var n;
                    return (
                        (n = this.ctx.createRadialGradient(t, i, e, t, i, s)).addColorStop(0, this.options.shadowColor),
        ...
        "function" == typeof window.define && null != window.define.amd
            ? define(function () {
                  return { Gauge: o, Donut: n, BaseDonut: e, TextRenderer: h, AnimationUpdater: i };
              })
            : "undefined" != typeof module && null != module.exports
            ? (module.exports = { Gauge: o, Donut: n, BaseDonut: e, TextRenderer: h, AnimationUpdater: i })
